...
INSERT INTO item_acervo (id, bibliotecaId, categoria, titulo, autor, sinopse, edicao, isbn, qteTotal, qteDisponivel, precoLocacao) VALUES
  ...
  (2, 1, 'APOSTILA', 'Como usar o MS Word 2013', 'GOMES, Jevanildo', 'Aprenda a usar esta ótima ferramenta da Microsoft e torne-se um profissional de ponta', NULL, NULL, 19, 19, 2.5500),
  (3, 1, 'TEXTO', 'As implicações do aquecimento global', 'SANTOS, Maria dos', 'Neste breve resumo sobre o clima e o aquecimento global o autor indaga a humanidade sobre questões primordiais a respeito das implicações do imprecedente aquecimento que o nosso planeta sofre nas últimas décadas', NULL, NULL, 1, 1, 1.2500),
  (4, 1, 'LIVRO', 'Como gastar seu dinheiro', 'GRANA, Salvio J.', 'Aprenda a utilizar o seu dinheiro de forma eficaz, valorizando a qualidade e diminuindo gastos desnecessários', NULL, NULL, 3, 3, 2.8500),
  (5, 2, 'APOSTILA', 'Como usar o MS Power Point 2013', 'SOUSA, Mario de', 'Aprenda a usar esta excelente ferramenta de apresentações e seja mestre na arte dos slides, prezi é coisa do passado, com esta apostila você terá habilidades supremas na apresentação de slides', NULL, NULL, 20, 20, 3.5500),
  (6, 2, 'LIVRO', 'Harry Poter e a Ordem da Fênix', 'ROWLING, J. K.', 'Neste volume da série Harry Potter você, Harry, Hermione e Rony irão desvendar os mistérios do mundo bruxo e enfrentar comensais da morte de perto', NULL, NULL, 30, 30, 6.5500),

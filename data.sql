...
INSERT INTO item_acervo (id, bibliotecaId, categoria, titulo, autor, sinopse, edicao, isbn, qteTotal, qteDisponivel, precoLocacao) VALUES
  (1, 1, 'LIVRO', 'Use a cabeça! Java', 'NASCIMENTO, Capitão', 'Use a "cabeça" e comece a utilizar esta ótima linguagem de programação. Use a cabeça! utiliza uma linguagem informal porém nada retrograda para lhe ensinar todos os macetes desta linguagem de pogramação', NULL, NULL, 10, 0, 12.2500),

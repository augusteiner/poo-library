...
INSERT INTO item_acervo (id, bibliotecaId, categoria, titulo, autor, edicao, isbn, qteTotal, qteDisponivel, precoLocacao) VALUES
    ...
    (8, 3, 'LIVRO', 'Como ganhar na loteria, Vol. I', 'GRANA, José Muita', NULL, NULL, 10, 0, 3.5500),
    (9, 3, 'LIVRO', 'Harry Potter e a Pedra Filosofal', 'ROWLING, J. K.', NULL, NULL, 10, 0, 3.5500);
